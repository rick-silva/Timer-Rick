    ...
    export const BackgroundBTN = () =>{
        ...
        return(
                ...
                <div className="w-96 h-20 flex justify-center items-center bg-opacity-70 bg-white bg-clip-padding rounded-lg absolute top-10" >
                ...
                <button className="w-16 m-2.5 rounded-md bg-gradient-to-r from-green-400 to-blue-500" onClick={resetBackground}>Reset</button>
                </div>
