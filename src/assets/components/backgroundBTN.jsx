        ...
        if(window.screen.width <= 500){
            return(
                <div className="w-96 h-20 flex justify-center items-center bg-opacity-70 bg-white bg-clip-padding rounded-lg absolute top-10 max-lg:w-80 max-lg:h-16 max-md:w-72 max-md:h-14" >
                    ...
                    <img className="w-24 h-12 cursor-pointer max-lg:w-20 max-lg:h-11 max-md:w-16 max-md:h-10" onClick={() => {backgroundIMG("https://media.giphy.com/media/Eqz8ZFUScPHH2/giphy.gif", "bg1")}} src="https://media.giphy.com/media/Eqz8ZFUScPHH2/giphy.gif" alt=""/>
                    
                    <img className="w-24  h-12 cursor-pointer max-lg:w-20 max-lg:h-11 max-md:w-16 max-md:h-10" onClick={() => {backgroundIMG("https://i.pinimg.com/originals/27/86/26/278626e6a8d3e055fa4ea6ccb53aff8d.png", "bg2")}} src="https://i.pinimg.com/originals/27/86/26/278626e6a8d3e055fa4ea6ccb53aff8d.png" alt=""/>

                    <img className="w-24 h-12 cursor-pointer max-lg:w-20 max-lg:h-11 max-md:w-16 max-md:h-10" onClick={() => {backgroundIMG("https://mobimg.b-cdn.net/v3/fetch/62/62e3ce60fc426fe6f475764cd99779b9.jpeg", "bg3")}} src="https://mobimg.b-cdn.net/v3/fetch/62/62e3ce60fc426fe6f475764cd99779b9.jpeg" alt=""/>
